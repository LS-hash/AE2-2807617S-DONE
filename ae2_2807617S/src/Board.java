...
public class Board {
    ...
    // TODO one to populate the board data structure with Square objects.
    public static Square[][] generateFixedBoard() {
    ...
    // TODO The other will be responsible for generating battleships.
